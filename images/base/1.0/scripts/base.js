...
var fadeIns = [].slice.call(document.getElementsByClassName('fade-in')), height = (window.innerHeight || document.documentElement.clientHeight);

function updateFadeIns() {
	fadeIns = Array.prototype.filter.call(fadeIns, function(element) {
...
for(anchors = document.getElementsByTagName('a'), i = 0; i < anchors.length; i++) {
	anchors[i].addEventListener('touchstart', function() {
